...
namespace Intranet.Areas.Elements_Generaux.Models.Medias
{
    public class DalMedia 
    {
        ...
        //    Element_Communautaire element = bdd.ElementsGeneraux.Add(new Element_Communautaire { Etat = Element.Etats.Publié });
